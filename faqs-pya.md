...
El primer paso es conocer la situación de la empresa, sus necesidades y los objetivos que quiere alcanzar. A partir de esa primera conversación definimos el alcance del proyecto y proponemos la solución que mejor se adapte a cada caso.

---

### ¿Tengo que contratar todos los servicios?

No. Puedes contratar únicamente el servicio que necesites: Control de Gestión, Planificación y Análisis Financiero, Contabilidad, Fiscalidad, Digitalización o Automatización. También es posible combinar varios servicios cuando el proyecto lo requiera.

---

### ¿Trabajáis con empresas de cualquier sector?

Sí. Adaptamos nuestra metodología de trabajo a las características de cada empresa, independientemente de su actividad, tamaño u organización.

---

### ¿Cómo es la comunicación durante el proyecto?

La comunicación es directa, clara y orientada a la toma de decisiones. La frecuencia y el formato de las reuniones se adaptan a las necesidades de cada proyecto.
