...
*Pendiente: redactar el hero propio (título + descripción breve) — puede usar como base la frase ya definida en la sección Áreas de la Home.*
...
*Pendiente: redactar el hero propio (título + descripción breve).*
...
- **Deploy**: subida por FTP al hosting existente — *pendiente decidir si manual bajo demanda o automatizado con GitHub Action.*
...
- Preguntas y lógica de recomendación del Diagnóstico rápido
...
- Deploy: manual o automatizado con GitHub Action
